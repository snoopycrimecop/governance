---
title: OMERO.server charter
permalink: /governance/projects/omero-server/charter/
description: Charter for OME OMERO.server
---

# Charter for OMERO.server

## **Overview**

This document formalizes the default governance for the OMERO.server OME
...
The current Chair is [Sébastien Besson (Glencoe Software)](https://github.com/sbesson).
...
OMERO.server project, decisions may impact other ORPs (in particular, Core Model,
Bio-Formats, NGFF and OMERO.web). When making decisions that impact other ORPs, all
...
- semi-privately, in dedicated weekly meetings which span OMERO.server and related plugins,
...
Code and documentation in the scope of the OMERO.server project are divided into the
...
- https://github.com/ome/omero-server-docker
- https://github.com/ome/omero-documentation

### **Release Processes**

The process for a full OMERO.server release is documented on the
[OMERO.server release page](https://ome-contributing.readthedocs.io/en/latest/omero-release-process.html).
These pages are updated as needed via pull requests to the
[ome-contributing](https://github.com/ome/ome-contributing) repository.

## **Code of Conduct**

As a Registered Project, OMERO.server adheres to the OME Project's
[Code of Conduct](../../../code-of-conduct/).
The OMERO.server project and prospective contributors are expected to adhere
